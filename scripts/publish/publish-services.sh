...
project_path="./FileIt.Module.Services.Host/FileIt.Module.Services.Host.csproj"
zip_path="./FileIt.Module.Services.Host/bin/Release/net10.0/FileIt.Module.Services.Host.zip"
...
if [ ! -f "$publish_dir/FileIt.Module.Services.Host.deps.json" ]; then
  echo "ERROR: Publish output is missing FileIt.Module.Services.Host.deps.json"
  exit 1
fi
