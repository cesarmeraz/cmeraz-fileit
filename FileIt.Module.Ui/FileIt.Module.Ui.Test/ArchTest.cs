...
public class ArchitectureTests
{
    private static readonly Architecture Architecture = new ArchLoader()
        .LoadAssemblies(
            ...
            typeof(FileIt.Module.Ui.App.UiConfig).Assembly,
            typeof(FileIt.Module.Ui.Health).Assembly
        )
        .Build();
    ...
    {
        var testLayer = Types().That().HaveFullNameContaining("FileIt.Domain.");
        var targetLayer = Types().That().HaveFullNameContaining("FileIt.Module.Ui.");
    ...
    {
        var testLayer = Types().That().HaveFullNameContaining("FileIt.Domain.");
        var targetLayer = Types().That().HaveFullNameContaining("FileIt.Module.Ui.App.");
    ...
    public void Host_Should_Not_Have_Dependency_On_Domain()
    {
        ...
        var testLayer = Types()
            .That()
            .HaveFullNameContaining("FileIt.Module.Ui.")
            .And()
            .DoNotHaveFullNameContaining("FileIt.Module.Ui.App.");
    ...
    {
        var testLayer = Types().That().HaveFullNameContaining("FileIt.Module.Ui.App.");
        var targetLayer = Types().That().HaveFullNameContaining("FileIt.Infrastructure.");
