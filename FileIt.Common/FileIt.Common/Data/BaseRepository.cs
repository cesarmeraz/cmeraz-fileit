...
namespace FileIt.Common.Data
{
    ...
    public abstract class BaseRepository<T, D> : IRepository<T, D>
        where T : class, IAuditable
        where D : DbContext
    {
        protected IDbContextFactory<D> Factory { get; set; }

        public BaseRepository(IDbContextFactory<D> dbContextFactory)
        {
